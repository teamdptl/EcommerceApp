...
const SearchBar = ({ onChange }) => {
    ...
    return (
        <div class="mx-auto mt-5 w-screen max-w-screen-md py-20 leading-6">
            <form onSubmit={handleSearch} class="relative mx-auto flex w-full max-w-2xl items-center justify-between rounded-3xl border shadow-lg">
                ...
                <input type="name" value={isSearch} onChange={(e) => setSearch(e.target.value)} name="search" class="h-14 w-full rounded-3xl py-4 pr-40 pl-12 outline-none focus:ring-2" placeholder="Tìm kiếm......" />
